...
from web.models.prices import ProductPrice, PriceGroup
...
class CartAdmin(admin.ModelAdmin):
    list_display = ('id', 'client', 'created_date', 'amount', 'amount_with_discount', 'discount')
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_number', 'status', 'client', 'client_name', 'created_date', 'amount', 'amount_with_discount', 'delivery_method', 'payment_method')
    search_fields = ('order_number', 'client__username', 'client_email', 'client_name')
    list_filter = ('status', 'created_date', 'updated_date', 'delivery_method', 'payment_method')
    readonly_fields = ('created_date', 'updated_date')

    fieldsets = (
        (None, {
            'fields': ('order_number', 'status', 'client', 'client_name', 'client_email', 'client_phone', 'client_address', 'amount', 'amount_with_discount', 'discount', 'info', 'delivery_method', 'payment_method')
        }),
        ('Payment Information', {
            'fields': ('payment_date', 'payment_id', 'order_code', 'invoice', 'email_notification', 'overriden_invoice_number', 'overriden_invoice_date')
        }),
        ('Timestamps', {
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('order', 'product', 'name', 'qty', 'price', 'discount', 'info')
        }),
    )
